...
public interface Constants
{
	 ...
	 */
	/*
	 * HP Fortify "Use of Hard-coded Password - Password Management: Hardcoded Password" false positive
	 * This is not a hard-coded password, just a configuration flag related to passwords, to enable or disable passwords 
	 * being echoed on the CLI when a user is entering their password
	 */
	 ...
	 */
	/*
	 * HP Fortify "Use of Hard-coded Credentials - Key Management: Hardcoded Encryption Key" false positive
	 * This is not an encryption key, just a configuration flag that denotes if encryption should be enabled in the source.
	 */
